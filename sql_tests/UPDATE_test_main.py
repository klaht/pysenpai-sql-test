...
def ref_program():
    correct_answer = "UPDATE exhibition SET numberOfVisitors = 14000, numberOfOnlineVisitors = 50000 WHERE title = 'Navigating North' AND startDate = '2022-10-07' AND endDate = '2023-04-02' AND locationId = (SELECT locationId FROM location WHERE name = 'Museum of Contemporary Art Kiasma') AND isOnlineExhibition = 1; "
...
if __name__ == "__main__":
    ...
    test_query = "SELECT title, numberOfVisitors, numberOfOnlineVisitors FROM Exhibition;"
